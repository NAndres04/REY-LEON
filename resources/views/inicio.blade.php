...
<head>
    ...
    <title>KingLions Calama - @yield('tituloeducadora')</title>
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="#"
                                                ...
                                                <span class="relative group-hover:text-amber-800">Avisos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="group relative before:absolute before:inset-x-0 before:bottom-0 before:h-2">
                                                <span class="relative group-hover:text-amber-800">Justificativos</span>
                                            </a>
                                        </li>
