                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="/"
                                                ...
                                                <span class="relative group-hover:text-amber-800">Inicio</span>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <div class="relative inline-block text-left">
                                            ...
                                            <div Id="SubMenu"
                                                ...
                                                <div class="py-1" role="none">
                                                    ...
                                                    <a href="/trabajadores"
                                                        ...
                                                        role="menuitem" tabindex="-1" id="menu-item-0">Trabajadores</a>
                                                    <a href="/objetivos"
                                                        class="text-black block px-4 py-2 text-sm hover:bg-amber-300"
                                                        role="menuitem" tabindex="-1" id="menu-item-1">Objetivos</a>
                                                    <a href="/informacion"
                                                        class="text-black block px-4 py-2 text-sm hover:bg-amber-300"
                                                        role="menuitem" tabindex="-1" id="menu-item-2">Información</a>
                                                    <a href="/ubicacion"
                                                        class="text-black block px-4 py-2 text-sm hover:bg-amber-300"
                                                        role="menuitem" tabindex="-1" id="menu-item-2">Ubicación</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('login') }}"
                                                    class="px-6 py-3 rounded-full bg-gradient-to-r from-amber-300 to-amber-500 text-center text-white">
                                                    Personal Educativo
                                                </a>
                                            </div>
                                            <?php /* <div
