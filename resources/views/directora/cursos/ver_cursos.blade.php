            ...
            <table class="table border-separate items-center bg-transparent w-full ">
                ...
                @foreach ( $cursos as $cursos )
                    <tr class="bg-white shadow-2xl">
                        ...
                        <a href="/ver_alumnos"><button class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-amber-500 hover:text-white focus:outline-none ">Gestionar Curso</button></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
