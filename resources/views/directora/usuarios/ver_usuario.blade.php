        ...
        <div class="rounded-t mb-0 px-4 py-3 border-0">
            <div class="flex flex-wrap items-center">  
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    <h1 class="font-semibold text-2xl text-black ">Personal Educativo</h1>
                </div>     
                <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                    <a href="/agregar_usuario"><button class="px-5 py-2 border-green-500 border text-black rounded transition duration-300 hover:bg-green-500 hover:text-white focus:outline-none ">Agregar Educadora</button></a>
                </div>         
            </div>
        </div>
            ...
            <table class="table border-separate items-center bg-transparent w-full ">
                ...
                @foreach ( $usuarios as $users )
                    <tr class="bg-white shadow-2xl">
                        ...
                        <button class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-amber-500 hover:text-white focus:outline-none ">Ver Información</button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
