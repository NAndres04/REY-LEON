                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y">
                            <tr>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="text-left">{{ $asistencia->cursos->jornada }}</div>
                                    </div>
                                </td>
                                 <td class="p-2 whitespace-nowrap">
                                    <div class="text-center"><button class="px-1 py-1 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-500 hover:text-white focus:outline-none "><a href="{{ route ('asistencia.show', $asistencia) }}">Ver Asistencia</button></a></div>
                                </td>
                            </tr>
                        </tbody>
                        @endforeach
